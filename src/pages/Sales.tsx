...
const Sales = () => {
  ...
  const services = [
    { icon: Check, title: 'ייעוץ והערכת שווי', description: 'הערכת שווי מקצועית ומדויקת' },
    { icon: Check, title: 'ליווי משפטי מלא', description: 'ליווי משפטי מקצועי לאורך כל התהליך' },
    { icon: Check, title: 'מו"מ מקצועי', description: 'ניהול מו"מ מיטבי עבורכם' },
    { icon: Check, title: 'שיווק מתקדם', description: 'חשיפה מקסימלית בכל הפלטפורמות' },
  ];
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex gap-2">
                        <Button asChild className="flex-1">
                          <Link to={`/sales/property/${property.id}`}>פרטים נוספים</Link>
                        </Button>
                        <Button
                          variant="outline"
                          size="icon"
