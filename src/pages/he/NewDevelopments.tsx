...
const NewDevelopments = () => {
  ...
  return <div className="min-h-screen hebrew-luxury" dir="rtl">
      ...
      <FullScreenHero title="פרויקטים חדשים" backgroundImage="/images/hero-new-developments.jpg" minHeight="100vh" />
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {telAvivDevelopments.map((dev, idx) => <FlippablePropertyCard key={idx} {...dev} />)}
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {herzliyaDevelopments.map((dev, idx) => <FlippablePropertyCard key={idx} {...dev} />)}
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {philadelphiaDevelopments.map((dev, idx) => <FlippablePropertyCard key={idx} {...dev} />)}
          </div>
        </div>
      </section>
