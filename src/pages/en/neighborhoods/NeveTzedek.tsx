            ...
            <Card className="p-6 sticky top-4 shadow-lg">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="font-playfair text-xl font-bold">₪5M - ₪15M</p>
                  <p className="font-montserrat text-sm text-muted-foreground">
                    Rentals: ₪12,000 - ₪30,000/mo
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="font-montserrat text-sm">South Tel Aviv</p>
                  <p className="font-montserrat text-sm text-muted-foreground">
                    Adjacent to Jaffa
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="font-montserrat text-sm">Restored homes, boutique buildings, villas</p>
                </div>
