...
export const ImageCarousel: React.FC<ImageCarouselProps> = React.memo(({
  ...
  const ThumbnailStrip = ({ dark = false }: { dark?: boolean }) => (
    <div className={`flex gap-2 p-3 overflow-x-auto scroll-smooth [&::-webkit-scrollbar]:hidden [scrollbar-width:none] ${dark ? 'bg-black/80' : ''}`} dir="rtl">
    ...
    <>
      ...
      <Card className={`${className} flex flex-col`}>
        <CardContent className="p-0 relative flex-1 flex flex-col">
          ...
          <div
            className="relative overflow-hidden rounded-t-lg md:rounded-xl bg-black/5 aspect-[4/3] lg:aspect-auto lg:h-[48vh] lg:max-h-[500px] min-h-[280px]"
            {...swipeHandlers}
          >
