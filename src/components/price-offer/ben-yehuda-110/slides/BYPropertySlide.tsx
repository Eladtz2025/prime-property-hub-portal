...
const BYPropertySlide = () => {
  ...
  const apartmentDetails = [{
    icon: Layers,
    text: "Duplex spanning Floors 4 & 5"
  }, {
    icon: Square,
    text: "Registered interior area: 53.23 sqm"
  }, {
    icon: Home,
    text: "Registered roof attachment: 19.78 sqm"
  }, {
    icon: Maximize,
    text: "Weighted area: approx. 69.9 sqm"
  }, {
    icon: Sun,
    text: "Two private outdoor spaces"
  }, {
    icon: Shield,
    text: "MAMAD (secure room)"
  }, {
    icon: FileCheck,
    text: "Full ownership, clear registration"
  }];
  const buildingDetails = [{
    icon: Building2,
    text: "Boutique residential building"
  }, {
    icon: Layers,
    text: "4 floors | 15 apartments"
  }, {
    icon: ArrowUpDown,
    text: "Elevator"
  }, {
    icon: Sparkles,
    text: "Well-maintained residential atmosphere"
  }];
  return <div className="relative flex h-full w-full flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center text-center px-4 md:px-8 py-6 md:py-8">
        {/* Main Title */}
        <h1 className="text-lg md:text-3xl lg:text-4xl font-serif font-light text-white mb-3 md:mb-6" style={{
        textShadow: softShadow
      }}>
          <span className="md:hidden">3-Room Duplex | ~70 sqm</span>
          <span className="hidden md:inline">Duplex Apartment | 3-Room | Approx. 70 sqm</span>
        </h1>
        ...
        <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6" dir="ltr">
          ...
          <div className="bg-[#8b7765]/70 backdrop-blur-sm rounded-lg p-4 md:p-6 text-left">
            <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
              ...
              <h3 className="text-base md:text-lg font-serif font-medium text-white uppercase tracking-wider" style={{
              textShadow: softShadow
            }}>
                The Apartment
              </h3>
            ...
            <ul className="space-y-1.5 md:space-y-2">
              ...
              return <li key={index} className="flex items-start gap-2 text-white/90 text-xs md:text-sm font-light" style={{
