interface BYFeaturesSlideProps {
  content?: {
    title?: string;
    features?: string[];
  };
...
const BYFeaturesSlide = ({ content }: BYFeaturesSlideProps) => {
    ...
    <div className="relative flex h-full w-full flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center text-center px-8 py-16">
        ...
        <h2 
          ...
          style={{ textShadow: softShadow }}
        >
          {content?.title || "UNIQUE FEATURES & POSITIONING"}
        </h2>
        ...
        <div className="bg-[#8b7765]/85 backdrop-blur-sm rounded-lg p-8 md:p-12 max-w-3xl">
          <p className="text-white/90 text-lg md:text-xl font-light leading-relaxed">
            {content?.features?.join(" • ") || "Content coming soon..."}
          </p>
        </div>
      </div>
