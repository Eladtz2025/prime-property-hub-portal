    ...
    <div className="relative h-full w-full flex flex-col items-center justify-center px-8 pt-24 pb-32">
      ...
      <div className="grid grid-cols-2 gap-8 max-w-4xl w-full">
        {stats.map((stat, index) => (
          <div
            key={index}
            className="flex flex-col items-center justify-center p-8 md:p-12 border border-white/10 rounded-2xl backdrop-blur-sm bg-gradient-to-br from-white/5 to-white/0"
          >
            <span className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 tabular-nums" dir="ltr">
              {formatValue(stat)}
            </span>
