  ...
  if (isMobile) {
    ...
    return (
      <div className="min-h-screen flex flex-col w-full bg-background">
        <header className="h-16 border-b bg-card/80 backdrop-blur-sm flex items-center justify-between px-4 sticky top-0 z-50 shadow-sm flex-row-reverse" dir="rtl">
  ...
  return (
    <div className="min-h-screen flex flex-col w-full bg-background">
      <header className="h-16 border-b bg-card/80 backdrop-blur-sm sticky top-0 z-40 shadow-sm">
        <div className="flex items-center justify-between px-6 h-full max-w-screen-2xl mx-auto gap-4 flex-row-reverse" dir="rtl">
          {/* Logo on the right in RTL */}
          <div className="flex items-center gap-3 flex-shrink-0 flex-row-reverse" dir="rtl">
