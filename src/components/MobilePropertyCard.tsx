...
export const MobilePropertyCard: React.FC<MobilePropertyCardProps> = memo(({ 
  ...
  return (
    <Card className="mb-3 shadow-card hover:shadow-elevated transition-all duration-200 bg-card border border-border/50 rounded-xl overflow-hidden relative isolate mobile-card">
      <CardContent className="p-4 space-y-3 mobile-card-content">
        {/* Address and Status Row */}
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-2 flex-1 min-w-0 flex-container-mobile">
            <MapPin className="h-4 w-4 text-muted-foreground flex-shrink-0" />
            <span className="font-medium text-sm text-foreground text-truncate-mobile">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex gap-1 flex-shrink-0 mobile-buttons">
