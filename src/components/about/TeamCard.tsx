  ...
  return (
    ...
    >
      <div className="relative h-48 sm:h-56 md:h-64 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-background/90 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-4 sm:p-6">
      ...
      <div className="p-4 sm:p-6 text-center">
        <h3 className="font-playfair text-lg sm:text-xl font-semibold text-foreground mb-1">
          {name}
        </h3>
