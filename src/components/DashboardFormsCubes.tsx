...
export const DashboardFormsCubes = () => {
  ...
  const cubeBase = "flex flex-row items-center px-3 py-2 h-10 rounded-lg bg-muted/80 backdrop-blur-sm border border-border/50 shadow-sm hover:bg-muted transition-all duration-200 cursor-pointer gap-2";
    ...
    <>
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-2" dir="rtl">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <button className={cubeBase}>
              ...
              <span className="flex-1 text-xs font-medium text-center">לינק ללקוח</span>
            </button>
          </PopoverTrigger>
        ...
        <Popover>
          <PopoverTrigger asChild>
            <button className={cubeBase}>
              {copiedPro ? <Check className="h-4 w-4 shrink-0" /> : <Link2 className="h-4 w-4 shrink-0" />}
              <span className="flex-1 text-xs font-medium text-center">לינק אנשי מקצוע</span>
            </button>
          </PopoverTrigger>
          <PopoverContent className="w-48 p-2" align="center">
            <div className="flex flex-col gap-1.5">
