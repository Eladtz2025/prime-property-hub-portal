          ...
          <nav className="hidden lg:flex items-center gap-6">
            {rightNavItems.map((item) => (
              <button
                ...
                className={`relative font-heebo text-sm tracking-wide font-semibold transition-all duration-200 drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]
            ...
            <div className="flex flex-col gap-4 px-4">
              {[...rightNavItems, ...leftNavItems].map((item) => (
                <button
                  ...
                  className={`font-heebo text-sm tracking-wide text-right py-2 transition-colors duration-200 ${
                    isActive(item.path)
