...
const DivisionCard = ({ title, image, link }: DivisionCardProps) => {
  return (
    <Link to={link}>
      <div className="group relative aspect-[3/4] overflow-hidden cursor-pointer animate-fade-in" dir="rtl">
        <img
          src={image}
          alt={title}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-12 px-6 text-white">
          <h3 className="font-playfair text-2xl md:text-3xl font-normal tracking-[0.15em] transition-transform duration-500 group-hover:-translate-y-1">
            {title}
          </h3>
