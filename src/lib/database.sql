...
-- Create first super admin user (you'll need to update this with your email)
-- This will be created when you first sign up with Google or email
-- You can manually update the role in the database or create a one-time function
