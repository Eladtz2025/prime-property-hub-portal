...
export async function generateSaleMemorandumPDF(formData: SaleMemorandumFormData): Promise<jsPDF> {
  ...
  const sectionStyle = `margin-bottom: 10px; padding: 8px 12px; background: #f8f9fa; border-radius: 6px; border-${isRTL ? 'right' : 'left'}: 4px solid #16a34a;`;
  const headerStyle = `font-size: 12px; font-weight: bold; margin: 0 0 6px 0; color: #166534;`;
  ...
  container.innerHTML = `
    <!-- Header -->
    <div style="text-align: center; margin-bottom: 10px; padding-bottom: 8px; border-bottom: 3px solid #16a34a;">
      <h1 style="font-size: 20px; margin: 0; color: #14532d; font-weight: bold;">${t.title}</h1>
    ...
    <!-- Signatures -->
    <div style="margin-top: 12px; padding-top: 10px; border-top: 3px solid #16a34a;">
      <div style="display: flex; justify-content: space-around; gap: 30px;">
        <div style="text-align: center; flex: 1; padding: 8px; background: #f8fafc; border-radius: 6px;">
          <p style="font-size: 11px; font-weight: bold; margin-bottom: 6px; color: #166534;">${t.agentSignature}</p>
        ...
        <div style="text-align: center; flex: 1; padding: 8px; background: #f8fafc; border-radius: 6px;">
          <p style="font-size: 11px; font-weight: bold; margin-bottom: 6px; color: #166534;">${t.buyerSignature}</p>
