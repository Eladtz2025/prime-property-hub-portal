-- Reset all properties stuck in "manual review" back to the automated queue
UPDATE scouted_properties 
SET availability_retry_count = 0 
WHERE availability_retry_count >= 2 AND is_active = true;

-- Update the RPC function to remove the retry_count filter
