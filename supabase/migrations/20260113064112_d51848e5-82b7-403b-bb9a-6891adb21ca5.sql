-- Schedule check-property-availability to run daily at 05:00 Israel time (03:00 UTC)
SELECT cron.schedule(
  'check-property-availability-job',
  '0 3 * * *',
  $$
  SELECT net.http_post(
    url := 'https://jswumsdymlooeobrxict.supabase.co/functions/v1/check-property-availability',
