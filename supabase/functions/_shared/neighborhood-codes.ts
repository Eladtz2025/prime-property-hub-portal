...
export const yad2NeighborhoodCodes: Record<string, string> = {
  // === NEW: Source-specific values from UI (yad2_* prefix) ===
  'yad2_צפון_ישן': '1483',
  'yad2_צפון_חדש': '204',
...
export const madlanNeighborhoodSubAreas: Record<string, string[]> = {
  ...
  // Each maps to exactly ONE sub-area (as shown in UI)
  ...
  // רוטשילד הוסר - לא קיים כשכונה במדל"ן! הנכסים נכללים ב"לב תל אביב"
  'madlan_שרונה': ['שכונה-שרונה'],  // הוספה חדשה
